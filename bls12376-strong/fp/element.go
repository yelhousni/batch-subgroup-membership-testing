...
const (
	...
	Bits  = 376 // number of bits needed to represent a Element
	Bytes = 48  // number of bytes needed to represent a Element
)

// Field modulus q
const (
	q0 = 1392571182119299755
	q1 = 17732678817110295176
	q2 = 6833235323646835000
	q3 = 4953067958500430863
	q4 = 11895087823808086915
	q5 = 65949697719434909
)
...
const qInvNeg = 12533140639073697789

func init() {
	_modulus.SetString("ea4ce6919c7e9da513d75a5627c38344bcd510d6c9940f5ed48752a49ef938f617216eb1f402881353681caaaaaaab", 16)
}
...
func (z *Element) SetOne() *Element {
	z[0] = 17301009810325503907
	z[1] = 14756765854097030578
	z[2] = 11988728368326402795
	z[3] = 1599845106596160319
	z[4] = 1684430425263041520
	z[5] = 46778409987211825
	return z
}
...
func (z *Element) IsOne() bool {
	return ((z[5] ^ 46778409987211825) | (z[4] ^ 1684430425263041520) | (z[3] ^ 1599845106596160319) | (z[2] ^ 11988728368326402795) | (z[1] ^ 14756765854097030578) | (z[0] ^ 17301009810325503907)) == 0
}
...
func (z *Element) LexicographicallyLargest() bool {
	...
	var b uint64
	_, b = bits.Sub64(_z[0], 696285591059649878, 0)
	_, b = bits.Sub64(_z[1], 8866339408555147588, b)
	_, b = bits.Sub64(_z[2], 12639989698678193308, b)
	_, b = bits.Sub64(_z[3], 11699906016104991239, b)
	_, b = bits.Sub64(_z[4], 15170915948758819265, b)
	_, b = bits.Sub64(_z[5], 32974848859717454, b)
...
// It uses Pornin20's binary GCD algorithm.
...
// legendreExp returns the Legendre symbol of z (either +1, -1, or 0.)
// It uses Euler's criterion i.e. z^((q-1)/2) (mod q).
func (z *Element) legendreExp() int {
	var l Element
	// z^((q-1)/2)
...
// legendreExp returns the Legendre symbol of z (either +1, -1, or 0.)
// It uses the binary GCD algorithm.
func (x *Element) legendreBinGCD() int {
	// initialize a = x
	a := *x
	// initialize n = q
	n := Element{
...
const (
	inversionCorrectionFactorWord0 = 11682221643357617065
	inversionCorrectionFactorWord1 = 182518350402044505
	inversionCorrectionFactorWord2 = 15250899885770302289
	inversionCorrectionFactorWord3 = 4240309955315705032
	inversionCorrectionFactorWord4 = 2551502835623058461
	inversionCorrectionFactorWord5 = 43399492179099780
	invIterationsN                 = 26
)
