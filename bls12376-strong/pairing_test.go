...
func TestPairing(t *testing.T) {
	...
	properties.Property("[BLS12-376-STRONG] Having the receiver as operand (final expo) should output the same result", prop.ForAll(
		func(a GT) bool {
	...
	properties.Property("[BLS12-376-STRONG] Exponentiating FinalExpo(a) to r should output 1", prop.ForAll(
		func(a GT) bool {
			b := FinalExponentiation(&a)
	...
	properties.Property("[BLS12-376-STRONG] Exp, CyclotomicExp and ExpGLV results must be the same in GT (small and big exponents)", prop.ForAll(
	...
	properties.Property("[BLS12-376-STRONG] Expt(Expt) and Exp(t^2) should output the same result in the cyclotomic subgroup", prop.ForAll(
		func(a GT) bool {
			var b, c, d GT
			b.Conjugate(&a)
			a.Inverse(&a)
	...
	properties.Property("[BLS12-376-STRONG] bilinearity", prop.ForAll(
	...
	properties.Property("[BLS12-376-STRONG] PairingCheck", prop.ForAll(
		func(a, b fr.Element) bool {
	...
	properties.Property("[BLS12-376-STRONG] Pair should output the same result with MillerLoop or MillerLoopFixedQ", prop.ForAll(
		func(a, b fr.Element) bool {
...
func TestMillerLoop(t *testing.T) {
	...
	properties.Property("[BLS12-376-STRONG] MillerLoop of pairs should be equal to the product of MillerLoops", prop.ForAll(
		func(a, b fr.Element) bool {
	...
	properties.Property("[BLS12-376-STRONG] MillerLoop and MillerLoopFixedQ should skip pairs with a point at infinity", prop.ForAll(
		func(a, b fr.Element) bool {
	...
	properties.Property("[BLS12-376-STRONG] compressed pairing", prop.ForAll(
		func(a, b fr.Element) bool {
