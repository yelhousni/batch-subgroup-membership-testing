...
func TestE12Serialization(t *testing.T) {
	...
	properties.Property("[BLS12-377-STRONG] SetBytes(Bytes()) should stay constant", prop.ForAll(
		func(a *E12) bool {
			var b E12
			buf := a.Bytes()
...
func TestE12ReceiverIsOperand(t *testing.T) {
	...
	properties.Property("[BLS12-377-STRONG] Having the receiver as operand (Cyclotomic square) should output the same result", prop.ForAll(
		func(a *E12) bool {
			var b E12
	...
	properties.Property("[BLS12-377-STRONG] Having the receiver as operand (Conjugate) should output the same result", prop.ForAll(
		func(a *E12) bool {
			var b E12
			b.Conjugate(a)
			a.Conjugate(a)
	...
	properties.Property("[BLS12-377-STRONG] Having the receiver as operand (Frobenius) should output the same result", prop.ForAll(
		func(a *E12) bool {
			var b E12
			b.Frobenius(a)
			a.Frobenius(a)
	...
	properties.Property("[BLS12-377-STRONG] Having the receiver as operand (FrobeniusSquare) should output the same result", prop.ForAll(
		func(a *E12) bool {
			var b E12
			b.FrobeniusSquare(a)
			a.FrobeniusSquare(a)
...
func TestE12Ops(t *testing.T) {
	...
	properties.Property("[BLS12-377-STRONG] a + pi(a), a-pi(a) should be real", prop.ForAll(
		func(a *E12) bool {
			var b, c, d E12
			var e, f, g E6
			b.Conjugate(a)
	...
	properties.Property("[BLS12-377-STRONG] Torus-based Compress/decompress E12 elements in the cyclotomic subgroup", prop.ForAll(
		func(a *E12) bool {
			var b E12
			b.Conjugate(a)
			a.Inverse(a)
	...
	properties.Property("[BLS12-377-STRONG] Torus-based batch Compress/decompress E12 elements in the cyclotomic subgroup", prop.ForAll(
		func(a, e, f *E12) bool {
			var b E12
			b.Conjugate(a)
			a.Inverse(a)
	...
	properties.Property("[BLS12-377-STRONG] pi**12=id", prop.ForAll(
		func(a *E12) bool {
			var b E12
			b.Frobenius(a).
				Frobenius(&b).
	...
	properties.Property("[BLS12-377-STRONG] (pi**2)**6=id", prop.ForAll(
		func(a *E12) bool {
			var b E12
			b.FrobeniusSquare(a).
				FrobeniusSquare(&b).
	...
	properties.Property("[BLS12-377-STRONG] cyclotomic square (Granger-Scott) and square should be the same in the cyclotomic subgroup", prop.ForAll(
		func(a *E12) bool {
			var b, c, d E12
			b.Conjugate(a)
			a.Inverse(a)
	...
	properties.Property("[BLS12-377-STRONG] compressed cyclotomic square (Karabina) and square should be the same in the cyclotomic subgroup", prop.ForAll(
		func(a *E12) bool {
	...
	properties.Property("[BLS12-377-STRONG] batch decompress and individual decompress (Karabina) should be the same", prop.ForAll(
		func(a *E12) bool {
			var _a, b E12
			_a.SetOne().Double(&_a)
	...
	properties.Property("[BLS12-377-STRONG] Exp and CyclotomicExp results must be the same in the cyclotomic subgroup", prop.ForAll(
	...
	properties.Property("[BLS12-377-STRONG] Frobenius of x in E12 should be equal to x^q", prop.ForAll(
		func(a *E12) bool {
			var b, c E12
			q := fp.Modulus()
			b.Frobenius(a)
	...
	properties.Property("[BLS12-377-STRONG] FrobeniusSquare of x in E12 should be equal to x^(q^2)", prop.ForAll(
		func(a *E12) bool {
			var b, c E12
			q := fp.Modulus()
			b.FrobeniusSquare(a)
