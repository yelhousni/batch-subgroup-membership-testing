...
func TestG2Endomorphism(t *testing.T) {
	...
	properties.Property("[BLS12-377-STRONG] check that psi^2(P) = -phi(P)", prop.ForAll(
		func(a fptower.E2) bool {
			var p, res1, res2 G2Jac
			g := MapToG2(a)
			p.FromAffine(&g)
...
func TestIsOnG2(t *testing.T) {
	...
	properties.Property("[BLS12-377-STRONG] g2Gen (affine) should be on the curve", prop.ForAll(
		func(a fptower.E2) bool {
	...
	properties.Property("[BLS12-377-STRONG] g2Gen (Jacobian) should be on the curve", prop.ForAll(
		func(a fptower.E2) bool {
...
func TestG2AffineOps(t *testing.T) {
	...
	properties.Property("[BLS12-377-STRONG] psi should map points from E' to itself", prop.ForAll(
		func() bool {
			var a G2Jac
			a.psi(&g2Gen)
