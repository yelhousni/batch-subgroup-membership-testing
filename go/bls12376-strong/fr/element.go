...
// Modulus q =
//
//	q[base10] = 5631470122511379517272145165437617506925656647120516793001660731363795402753
//	q[base16] = 0xc734c9428876f0384334fc1cb852a71933b8f2c9102a034f0707e4c00000001
//
// # Warning
//
...
// Field modulus q
const (
	q0 = 17325486631376912385
	q1 = 10609230768775536692
	q2 = 9526045330580515441
	q3 = 897144949995695875
)
...
const qInvNeg = 17325486631376912383

// mu = 2^288 / q needed for partial Barrett reduction
const mu uint64 = 88311440101

func init() {
	_modulus.SetString("c734c9428876f0384334fc1cb852a71933b8f2c9102a034f0707e4c00000001", 16)
}
...
func (z *Element) SetOne() *Element {
	z[0] = 3978404772943233004
	z[1] = 9176313509003885533
	z[2] = 12393278199194758944
	z[3] = 503845073795634105
	return z
}
...
func (z *Element) IsOne() bool {
	return ((z[3] ^ 503845073795634105) | (z[2] ^ 12393278199194758944) | (z[1] ^ 9176313509003885533) | (z[0] ^ 3978404772943233004)) == 0
}
...
func (z *Element) LexicographicallyLargest() bool {
	...
	var b uint64
	_, b = bits.Sub64(_z[0], 8662743315688456193, 0)
	_, b = bits.Sub64(_z[1], 14527987421242544154, b)
	_, b = bits.Sub64(_z[2], 13986394702145033528, b)
	_, b = bits.Sub64(_z[3], 448572474997847937, b)
...
const (
	inversionCorrectionFactorWord0 = 5425026124162386149
	inversionCorrectionFactorWord1 = 7335723493703437725
	inversionCorrectionFactorWord2 = 3773118393882354480
	inversionCorrectionFactorWord3 = 694294666991530926
	invIterationsN                 = 18
)
