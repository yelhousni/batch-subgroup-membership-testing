...
func TestElementFixedExp(t *testing.T) {
	...
	_bLegendreExponentElement, _ = new(big.Int).SetString("639a64a1443b781c219a7e0e5c29538c99dc7964881501a78383f2600000000", 16)
	const sqrtExponentElement = "18e69928510ede0708669f83970a54e326771e5922054069e0e0fc9"
	...
	properties.Property("expByLegendreExp must match Exp(639a64a1443b781c219a7e0e5c29538c99dc7964881501a78383f2600000000)", prop.ForAll(
		func(a testPairElement) bool {
			c := a.element
			d := a.element
