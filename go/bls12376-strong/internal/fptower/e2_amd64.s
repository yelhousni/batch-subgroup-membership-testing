...
TEXT ·subE2(SB), NOSPLIT, $0-24
	...
	SBBQ    40(R8), DI
	MOVQ    x+8(FP), R8
	MOVQ    $0x1353681caaaaaaab, R10
	MOVQ    $0xf617216eb1f40288, R11
	MOVQ    $0x5ed48752a49ef938, R12
	MOVQ    $0x44bcd510d6c9940f, R13
	MOVQ    $0xa513d75a5627c383, R14
	MOVQ    $0x00ea4ce6919c7e9d, R15
	CMOVQCC R9, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
	...
	SBBQ    80(R8), SI
	SBBQ    88(R8), DI
	MOVQ    $0x1353681caaaaaaab, R11
	MOVQ    $0xf617216eb1f40288, R12
	MOVQ    $0x5ed48752a49ef938, R13
	MOVQ    $0x44bcd510d6c9940f, R14
	MOVQ    $0xa513d75a5627c383, R15
	MOVQ    $0x00ea4ce6919c7e9d, R10
	CMOVQCC R9, R11
	CMOVQCC R9, R12
	CMOVQCC R9, R13
	CMOVQCC R9, R14
...
l1:
	MOVQ $0x1353681caaaaaaab, CX
	SUBQ BX, CX
	MOVQ CX, 0(DX)
	MOVQ $0xf617216eb1f40288, CX
	SBBQ SI, CX
	MOVQ CX, 8(DX)
	MOVQ $0x5ed48752a49ef938, CX
	SBBQ DI, CX
	MOVQ CX, 16(DX)
	MOVQ $0x44bcd510d6c9940f, CX
	SBBQ R8, CX
	MOVQ CX, 24(DX)
	MOVQ $0xa513d75a5627c383, CX
	SBBQ R9, CX
	MOVQ CX, 32(DX)
	MOVQ $0x00ea4ce6919c7e9d, CX
	SBBQ R10, CX
	MOVQ CX, 40(DX)
