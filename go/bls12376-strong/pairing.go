	...
	for i := len(LoopCounter) - 3; i > 0; i-- {
		...
		for k := 0; k < n; k++ {
			...
			case -1:
				...
				result.MulBy01245(&prodLines)
			default:
				return GT{}, errors.New("invalid loop counter value")
			}
		}
	}
...
// lineCompute computes the line through p and a in Homogenous projective coordinates.
// It does not compute the resulting point p+a.
func (p *g2Proj) lineCompute(l *lineEvaluation, a *G2Affine) {
