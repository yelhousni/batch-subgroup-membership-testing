...
// Field modulus q
const (
	q0 = 3922024496859097771
	q1 = 6804722707389302642
	q2 = 9693309425372261977
	q3 = 5210159840222494280
	q4 = 12686599767852735395
	q5 = 102463700869045733
)
...
const qInvNeg = 16404775609982517245

func init() {
	_modulus.SetString("16c06316cabdde5b00fdb45ba6a5ba3484e34c52377be4886858d90a5426e595e6f3b3fd8f94772366dd48007aaaaab", 16)
}
...
func (z *Element) SetOne() *Element {
	z[0] = 13458609440034914244
	z[1] = 11081765608465482673
	z[2] = 7644990435400247593
	z[3] = 2955176519138161921
	z[4] = 3808306926492029233
	z[5] = 3277917281319552
	return z
}
...
func (z *Element) IsOne() bool {
	return ((z[5] ^ 3277917281319552) | (z[4] ^ 3808306926492029233) | (z[3] ^ 2955176519138161921) | (z[2] ^ 7644990435400247593) | (z[1] ^ 11081765608465482673) | (z[0] ^ 13458609440034914244)) == 0
}
...
func (z *Element) LexicographicallyLargest() bool {
	...
	var b uint64
	_, b = bits.Sub64(_z[0], 1961012248429548886, 0)
	_, b = bits.Sub64(_z[1], 12625733390549427129, b)
	_, b = bits.Sub64(_z[2], 4846654712686130988, b)
	_, b = bits.Sub64(_z[3], 11828451956966022948, b)
	_, b = bits.Sub64(_z[4], 15566671920781143505, b)
	_, b = bits.Sub64(_z[5], 51231850434522866, b)
...
const (
	inversionCorrectionFactorWord0 = 5464727932076616868
	inversionCorrectionFactorWord1 = 7976374876129922083
	inversionCorrectionFactorWord2 = 5606084066556095048
	inversionCorrectionFactorWord3 = 11177583922098633273
	inversionCorrectionFactorWord4 = 1902285337371197042
	inversionCorrectionFactorWord5 = 18709281823529188
	invIterationsN                 = 26
)
