...
import (
	...
	"github.com/yelhousni/batch-subgroup-membership/go/bls12377-strong/hash_to_curve"
)
...
func MapToCurve1(u *fp.Element) G1Affine {
	...
	Z := fp.Element{8470474806360276872, 3716787143221413731, 15289980870800495187, 5910353038276323842, 7616613852984058466, 6555834562639104}
	c1 := fp.Element{10447020518056918500, 7502170107641585983, 13464681697473573494, 8149844598533905676, 15828018264718711482, 29501255531875969}
	c2 := fp.Element{8910159130533735143, 14169701172633371584, 2048318989972014383, 2254983321084332359, 8878292841360706162, 99185783587726181}
	c3 := fp.Element{16704501274741771478, 18308024014144845882, 14281304131004870527, 2929953896240399002, 18238633229318851166, 93577944620807616}
	c4 := fp.Element{439684324173458271, 10452914029411957853, 5205082192881070812, 14791374356517560132, 1261678988376647695, 92629949025087077}
