...
func TestE2ReceiverIsOperand(t *testing.T) {
	...
	properties.Property("[BLS12-377-STRONG] Having the receiver as operand (mul by element) should output the same result", prop.ForAll(
	...
	properties.Property("[BLS12-377-STRONG] Having the receiver as operand (Sqrt) should output the same result", prop.ForAll(
		func(a *E2) bool {
			var b, c, d, s E2
...
func TestE2Ops(t *testing.T) {
	...
	properties.Property("[BLS12-377-STRONG] BatchInvertE2 should output the same result as Inverse", prop.ForAll(
		func(a, b, c *E2) bool {
	...
	properties.Property("[BLS12-377-STRONG] MulByElement MulByElement inverse should leave an element invariant", prop.ForAll(
		func(a *E2, b fp.Element) bool {
			var c E2
			var d fp.Element
			d.Inverse(&b)
	...
	properties.Property("[BLS12-377-STRONG] Double and mul by 2 should output the same result", prop.ForAll(
		func(a *E2) bool {
			var b E2
			var c fp.Element
			c.SetUint64(2)
	...
	properties.Property("[BLS12-377-STRONG] Legendre on square should output 1", prop.ForAll(
		func(a *E2) bool {
			var b E2
			b.Square(a)
			c := b.Legendre()
	...
	properties.Property("[BLS12-377-STRONG] square(sqrt) should leave an element invariant", prop.ForAll(
		func(a *E2) bool {
			var b, c, d, e E2
			b.Square(a)
			c.Sqrt(&b)
	...
	properties.Property("[BLS12-377-STRONG] neg(E2) == neg(E2.A0, E2.A1)", prop.ForAll(
		func(a *E2) bool {
			var b, c E2
			b.Neg(a)
			c.A0.Neg(&a.A0)
	...
	properties.Property("[BLS12-377-STRONG] Cmp and LexicographicallyLargest should be consistent", prop.ForAll(
		func(a *E2) bool {
			var negA E2
			negA.Neg(a)
